...
const Home = () => {
  ...
  <div className='homepage'>
    <div className='homeHeader'>
        ...
        <h3 className='headerDesc' style={{fontFamily: 'Urbanist', lineHeight: '1vh', fontSize: '3vh', margin: '20px 0px 0px 0px'}} >Full-Stack Developer</h3>
        <h4 className='headerDesc' style={{fontFamily: 'Urbanist', lineHeight: '1vh', fontSize: '4vh'}} >Oh, the possibilities</h4>
